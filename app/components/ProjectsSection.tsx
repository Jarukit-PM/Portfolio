          ...
          {duplicatedProjects.map((project, index) => {
            ...
            >
              {project.github ? (
                ...
                <motion.article
                  className="group relative h-full overflow-hidden rounded-2xl border border-zinc-800/70 bg-linear-to-br from-black via-zinc-950 to-zinc-900"
                  variants={cardVariants}
                  initial="hidden"
                  whileInView="visible"
                  viewport={{ once: true, amount: 0.25 }}
                ...
                >
                  ...
                  <div className="flex h-full flex-col">
                    ...
                    <div className="flex flex-1 flex-col gap-3 p-5 sm:p-6">
                      ...
                      <span className="mt-2 inline-flex items-center gap-1 text-[11px] font-medium uppercase tracking-[0.16em] text-zinc-400">
                        Private project
                      </span>
                    </div>
                  </div>
